...
public class EmpTest
{
	...
	public static void main(String[] args)
	{
		List<Employee> listOfEmp = new ArrayList<>();
			int ch;
			System.out.println("Enter records you want to store?");
		...
		do 
		{
			System.out.printlnMenu\n1. Sort By Id    1. Ascending Order   2. Descending Order");
			System.out.println("2. Sort By Name  1. Ascending Order   2. Descending Order");
			System.out.println("3. Sort By Salary   1. Ascending Order   2. Descending Order");
